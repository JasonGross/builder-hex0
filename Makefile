...
test-arm64-stage2-chain: arm64-stage2
	QEMU=$(QEMU_ARM64) TIMEOUT=$(TIMEOUT) ./test-arm64-stage2-chain.sh

test-arm64-stage2-pivot: arm64-stage2
	QEMU=$(QEMU_ARM64) TIMEOUT=$(TIMEOUT) ./test-arm64-stage2-pivot.sh
